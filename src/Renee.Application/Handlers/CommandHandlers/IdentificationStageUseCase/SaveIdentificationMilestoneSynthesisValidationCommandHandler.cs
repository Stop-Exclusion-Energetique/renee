...
public class SaveIdentificationMilestoneSynthesisValidationCommandHandler(
	IAccompanyingFileRepository accompanyingFileRepository,
	IUserRepository userRepository,
	ITelemetryService telemetryService)
	: IRequestHandler<SaveIdentificationMilestoneSynthesisValidationCommandInput, ReneeOperationResult<RequiredDataForStageSynthesisValidationEmail>>
{
	public async Task<ReneeOperationResult<RequiredDataForStageSynthesisValidationEmail>> Handle(
		SaveIdentificationMilestoneSynthesisValidationCommandInput request,
