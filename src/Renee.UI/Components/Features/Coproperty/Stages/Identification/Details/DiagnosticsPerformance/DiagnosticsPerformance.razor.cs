...
namespace Renee.UI.Components.Features.Coproperty.Stages.Identification.Details.DiagnosticsPerformance;

public partial class DiagnosticsPerformance
{
    [CascadingParameter] public EditContext EditContext { get; set; } = null!;

    [Parameter] public DiagnosticsPerformanceViewModel ViewModel { get; set; } = null!;
